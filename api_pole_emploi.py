...
CLIENT_ID="PAR_devopsformation_aac4316994da06cd6141fa63d128d2f34c5741bd75fc2a1b1885d400d7365647"

CLIENT_SECRET="1a4e48e59afcc58a46700f33137c6e6b89bc55859731b88dc0488c547503c481"
...
params.update({"minCreationDate": "2023-01-01T00:00:00Z"})

params.update({"maxCreationDate": "2023-01-02T00:00:00Z"})

result=client.search(params=params)

all_lists_of_offers=result["resultats"]

# print(all_lists_of_offers[0][id])

for i in all_lists_of_offers:
    print(i["id"])